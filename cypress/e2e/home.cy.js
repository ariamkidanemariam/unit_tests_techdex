describe("Home Page", () => {
  ...
  it("TC-008: should load the home page without errors", () => {
    cy.url().should("eq", baseUrl + "/");
    cy.get("body").should("be.visible");
    cy.get("nav, header").should("be.visible");
  });

  it("TC-009: should display the correct heading text", () => {
    cy.contains(
      'h1, h2, [class*="hero"]',
  ...
  it("TC-010: should display hero background image", () => {
    cy.get('section, div, [class*="hero"]')
      .find('img, [class*="background"], [style*="background"]')
      .should("exist");
  });

  it("TC-011: should have correct hero section colors", () => {
    cy.get("h1, h2")
      .first()
  ...
  it("TC-012: should display call-to-action buttons with correct colors", () => {
    cy.get("a, button")
  ...
  it("TC-013: should have How It Works accessible for buyers", () => {
  ...
  it("TC-014: should have About us accessible for buyers", () => {
  ...
  it("TC-015: should have Contact section accessible for cooperatives", () => {
